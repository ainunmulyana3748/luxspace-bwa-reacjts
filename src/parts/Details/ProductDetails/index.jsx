...
import imageOneBack from "../../../assets/images/ProductDetails/showcase-1.back.jpg";
import imageOneFront from "../../../assets/images/ProductDetails/showcase-1.front.jpg";
import imageOneRear from "../../../assets/images/ProductDetails/showcase-1.rear.jpg";
import imageOneSide from "../../../assets/images/ProductDetails/showcase-1.side.jpg";
import imageOneTop from "../../../assets/images/ProductDetails/showcase-1.top.jpg";
        ...
        <div className="flex-1">
          <div className="slider">
            <div className="thumbnail">
              <div className="px-2">
                <div className="item selected" data-img={imageOneFront}>
                  <img
                    src={imageOneFront}
                    alt="front"
              ...
              <div className="px-2">
                <div className="item" data-img={imageOneBack}>
                  <img
                    src={imageOneBack}
                    alt="back"
                    className="object-cover w-full h-full rounded-lg"
              ...
              <div className="px-2">
                <div className="item" data-img={imageOneRear}>
                  <img
                    src={imageOneRear}
                    alt="rear"
                    className="object-cover w-full h-full rounded-lg"
              ...
              <div className="px-2">
                <div className="item" data-img={imageOneSide}>
                  <img
                    src={imageOneSide}
                    alt="side"
                    className="object-cover w-full h-full rounded-lg"
              ...
              <div className="px-2">
                <div className="item" data-img={imageOneTop}>
                  <img
                    src={imageOneTop}
                    alt="top"
                    className="object-cover w-full h-full rounded-lg"
